...
class MyListingReviewsPage extends StatefulWidget {
  const MyListingReviewsPage({super.key});

  @override
  State<MyListingReviewsPage> createState() => _MyListingReviewsPageState();
}

class _MyListingReviewsPageState extends State<MyListingReviewsPage>
  ...
  final List<_ListingReviewItem> _reviews = [];
  ...
  Future<void> _fetchPage({required bool reset}) async {
    ...
    if (!valid) {
      ...
      setState(() {
        ...
        _reviews.clear();
        _hasMore = false;
        _error = t(_lang, "my_listing_reviews.session_expired");
      });
      return;
    }
    ...
    try {
      ...
      final incoming = results
          ...
          .map(
            (item) =>
                _ListingReviewItem.fromJson(Map<String, dynamic>.from(item)),
          )
          .toList();
      ...
      setState(() {
        _loading = false;
        _hydrated = true;
        _error = t(_lang, "my_listing_reviews.timeout");
      });
      ...
      setState(() {
        _loading = false;
        _hydrated = true;
        _error = t(_lang, "my_listing_reviews.load_failed");
      });
    }
  }
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    t(
                                      _lang,
                                      "my_listing_reviews.filters_title",
                                    ),
                                    style: TextStyle(
                                      fontSize: 18,
                            ...
                            Text(
                              t(_lang, "my_listing_reviews.filters_subtitle"),
                              style: TextStyle(
                                fontSize: 13,
                                height: 1.45,
                            ...
                            _SheetLabel(
                              text: t(
                                _lang,
                                "my_listing_reviews.filter_rating",
                              ),
                            ),
                            Wrap(
                            ...
                            _SheetLabel(
                              text: t(
                                _lang,
                                "my_listing_reviews.filter_published",
                              ),
                            ),
                            Wrap(
                            ...
                            _SheetLabel(
                              text: t(
                                _lang,
                                "my_listing_reviews.filter_reported",
                              ),
                            ),
                            Wrap(
                              children: [null, true, false].map((value) {
                            ...
                            _SheetLabel(
                              text: t(
                                _lang,
                                "my_listing_reviews.filter_ordering",
                              ),
                            ),
                            Wrap(
                            ...
                            const SizedBox(height: 14),
                            _SheetLabel(
                              text: t(_lang, "my_listing_reviews.filter_sort"),
                            ),
                            Wrap(
                            ...
                            _SheetLabel(
                              text: t(
                                _lang,
                                "my_listing_reviews.filter_page_size",
                              ),
                            ),
                              ...
                              children: [
                                Expanded(
                                  child: OutlinedButton(
                                    ...
                                    child: Text(
                                      t(_lang, "my_listing_reviews.reset"),
                                    ),
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: FilledButton(
                                    ...
                                    child: Text(
                                      t(_lang, "my_listing_reviews.apply"),
                                    ),
                                  ),
                                ),
                              ],
            ...
            children: [
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              t(lang, "my_listing_reviews.title"),
                              style: TextStyle(
                                fontSize: 28,
                                fontWeight: FontWeight.w900,
                                letterSpacing: -0.6,
                              ...
                              children: [
                                Expanded(
                                  child: _ReviewSearchBar(
                                    ...
                                    hintText: t(
                                      lang,
                                      "my_listing_reviews.search_hint",
                                    ),
                    ...
                    if (!_loading && _reviews.isEmpty && _error != null)
                      SliverFillRemaining(
                        ...
                        child: _LoadStatePanel(
                          ...
                          title: t(lang, "my_listing_reviews.error_title"),
                          description: _error!,
                          actionLabel: t(lang, "common.try_again"),
                    ...
                    if (!_loading &&
                      ...
                      SliverFillRemaining(
                        ...
                        child: _LoadStatePanel(
                          ...
                          title: t(lang, "my_listing_reviews.empty_title"),
                          description: _hasActiveFilters
                              ? t(lang, "my_listing_reviews.empty_filtered")
                              : t(lang, "my_listing_reviews.empty_default"),
                          actionLabel: _hasActiveFilters
                              ? t(lang, "my_listing_reviews.reset")
                              : null,
              ...
              AnimatedPositioned(
                ...
                child: FloatingActionButton.small(
                  heroTag: "my-listing-reviews-top",
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            item.placeName ??
                                t(lang, "my_listing_reviews.no_listing"),
                            maxLines: 2,
                          ...
                          Text(
                            item.comment?.trim().isNotEmpty == true
                                ? item.comment!.trim()
                                : t(lang, "my_listing_reviews.comment_empty"),
                            maxLines: 4,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontSize: 12.5,
                  ...
                  children: [
                    _ReviewPill(
                      label: item.published
                          ? t(lang, "my_listing_reviews.published")
                          : t(lang, "my_listing_reviews.unpublished"),
                    ...
                    _ReviewPill(
                      label: item.isReported
                          ? t(lang, "my_listing_reviews.reported")
                          : t(lang, "my_listing_reviews.not_reported"),
                      color: item.isReported ? scheme.error : scheme.tertiary,
                    ),
                    _ReviewPill(
                      label:
                          "${t(lang, "my_listing_reviews.rating")} ${item.rating}/5",
...
class _ListingReviewItem {
  ...
  factory _ListingReviewItem.fromJson(Map<String, dynamic> json) {
...
String _ratingLabel(String lang, int? rating) {
  if (rating == null) return t(lang, "my_listing_reviews.all_ratings");
  return "$rating★";
}

String _publishedLabel(String lang, bool? value) {
  if (value == null) return t(lang, "my_listing_reviews.published_all");
  return value
      ? t(lang, "my_listing_reviews.published_only")
      : t(lang, "my_listing_reviews.unpublished_only");
}

String _reportedFilterLabel(String lang, bool? value) {
  if (value == null) return t(lang, "my_listing_reviews.reported_all");
  return value
      ? t(lang, "my_listing_reviews.reported_only")
      : t(lang, "my_listing_reviews.clean_only");
}

String _orderingLabel(String lang, String value) {
  switch (value) {
    case "rating":
      return t(lang, "my_listing_reviews.ordering_rating");
    case "place_name":
      return t(lang, "my_listing_reviews.ordering_place_name");
    case "created_at":
    default:
      return t(lang, "my_listing_reviews.ordering_created");
  }
}

String _sortLabel(String lang, String value) {
  return value == "asc"
      ? t(lang, "my_listing_reviews.sort_asc")
      : t(lang, "my_listing_reviews.sort_desc");
}
