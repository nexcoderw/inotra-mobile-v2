...
class EventTicketsMetricsRow extends StatelessWidget {
  const EventTicketsMetricsRow({super.key, required this.items});

  final List<EventTicketMetricItem> items;
...
class _MetricCard extends StatelessWidget {
  ...
  final EventTicketMetricItem item;
