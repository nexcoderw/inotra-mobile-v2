...
class TripReservationsMetricsRow extends StatelessWidget {
  const TripReservationsMetricsRow({super.key, required this.items});

  final List<TripReservationMetricItem> items;
      ...
      child: Row(
        children: [
          for (var index = 0; index < items.length; index++) ...[
            _MetricCard(item: items[index], scheme: scheme),
...
class _MetricCard extends StatelessWidget {
  const _MetricCard({required this.item, required this.scheme});

  final TripReservationMetricItem item;
